        ...
        <section className="mb-16">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-3xl font-bold text-gray-800 border-b border-gray-200 pb-2 flex-grow">
              Over 50 Interactive Web Modules
            </h2>
          </div>
...
const interactiveWebPages = [
  ...
  { title: "Arabic Idafah I", category: "Arabic Grammar", description: "interactive dropdown challenge in Arabic possessive construct", url: "/web/arabic-idafah-i.html" },
  { title: "Arabic Idafah II", category: "Arabic Grammar", description: "Drag-and-drop puzzle that trains you to instantly flip possession and owner", url: "/web/arabic-idafah-ii.html" },
  { title: "Arabic Idafah III", category: "Arabic Grammar", description: "Case Ending, Fill in the Blank Selector that teaches everyday phrases", url: "/web/arabic-idafah-iii.html" },
  ...
  { title: "Arabic Word Sort", category: "Arabic Singular-Dual-Plural", description: "Learning Game on Singular, Dual, and Plural forms in Arabic", url: "/web/sing-dual-ii.html" },
  ...
  { title: "KY Faman-Liman Match", category: "Language Tool", description: "Master the two high-frequency particles فَمَنْ and لِمَنْ", url: "/web/ky-faman-liman.html" },
  ...
  { title: "One-Two-Many", category: "Arabic Singular-Dual-Plural", description: "Interactive quiz on Singular, Dual, and Plural forms in Arabic", url: "/web/sing-dual-i.html" },
